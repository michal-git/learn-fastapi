...
from backend.app.models.fill_gap_sentence import FillGapSentence
from backend.app.models.multiple_choice_question import MultipleChoiceQuestion
...
class Exercise(SQLModel, table=True):
    id: UUID = Field(default_factory=uuid4, primary_key=True, index=True)
    teacher_id: UUID = Field(foreign_key="teacher.id", nullable=False)
